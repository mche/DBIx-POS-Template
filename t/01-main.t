...
like($pos->{'тест'}->template, qr/BAR/, 'default 1');
...
like($pos2->{'тест'}->template, qr/FOO/, 'default 2');
like($pos->template('тест', join => $pos2->{'тест'}->template, ), qr/FOO/, 'template 1 on template 2 defaults');
